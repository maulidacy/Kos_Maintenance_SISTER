...
const links = [
  ...
  { href: '/teknisi/tasks', label: 'Tugas' },
];
...
export function TechnicianSidebar({ className = '', onNavigate }: Props) {
    ...
    >
      <nav className="space-y-1">
        {links.map((link) => {
          ...
          const activeClass =
            'bg-cyan-500/15 text-cyan-100 border border-cyan-500/50 shadow-sm shadow-cyan-500/40';
          const inactiveClass =
